...
for msg in consumer:
    ...
    print(country)
    print("-----------")
    cur.execute('''INSERT INTO cust_dat(username,sub_no,city,country) VALUES ('{}',{},'{}','{}');'''.format(name,num,city,country))
    #cur.execute('''INSERT INTO cust_dat(username,sub_no,city,country) VALUES ('Amit',602,'Kumar','Gupta')''')
